//
//  OtherTasksViewController.swift
//  ReRoot
//
...
class OtherTasksViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
...
//                print(response)
                ...
                do{
                    ...
                    if(self.tableViewDataSourceArray.count > 0){
                        self.title = "Other Tasks(\(self.tableViewDataSourceArray.count))"
                    }
                    else{
                        self.title = "Other Tasks"
                    }
...
//        detailsController.prospectType = .REGISTRATIONS
        detailsController.isFromLeads = isLeads
